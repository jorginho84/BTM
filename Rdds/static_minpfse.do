...
foreach depvar in "n_emp" "lw_2"{
	...
	* ---------------------- PANEL A: OVERALL ---------------------- *
	// PANEL A: ALL
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo, vce(robust)
	...
	// PANEL A: SINGLE
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & pareja == 0, vce(robust)
	...
	// PANEL A: MARRIED
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & pareja == 1, vce(robust)
	...
	* ---------------------- PANEL B: HAS CHILDREN UNDER 18 ---------------------- *
	// PANEL B: ALL
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & n_hijos_less18 > 0, vce(robust)
	...
	// PANEL B: SINGLE 
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & n_hijos_less18 > 0 & pareja == 0, vce(robust)
	...
	// PANEL B: MARRIED
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & n_hijos_less18 > 0 & pareja == 1, vce(robust)
	...
	* ---------------------- PANEL C: 12 YEARS OR LESS OF EDUCATION ---------------------- *
	// PANEL C: ALL
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & anios_educ <= 12, vce(robust)
	...
	// PANEL C: SINGLE 
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & anios_educ <= 12 & pareja == 0, vce(robust)
	...
	// PANEL C: MARRIED
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & anios_educ <= 12 & pareja == 1, vce(robust)
	...
	* ---------------------- PANEL D: 12 YEARS OR LESS OF EDUCATION OR HAS CHILDREN UNDER 18 ---------------------- *
	// PANEL D: ALL
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & anios_educ <= 12 & n_hijos_less18 > 0, vce(robust)
	...
	// PANEL D: SINGLE 
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & anios_educ <= 12 & n_hijos_less18 > 0 & pareja == 0, vce(robust)
	...
	// PANEL D: MARRIED
	qui:reg `depvar' d_eleg_ever min_pf d_eleg_ever#c.min_pf if min_pf <= h_optimo & min_pf >= -h_optimo & anios_educ <= 12 & n_hijos_less18 > 0 & pareja == 1, vce(robust)
...
* --- redo table 
file open table_rdd using "$salida/tablas_graficos/employment_static_long_minpfse.tex", write replace
