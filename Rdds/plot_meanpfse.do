...
* =========================================================
	...
	Table 3
	running var: d_eleg_ever (mean_pf)
* =========================================================
*/
...
// 2012
egen mean_pf_2012 = rowmean(PFSE_cent_2012*)
egen min_pf = rowmean(PFSE_cent_*)
gen d_eleg_2012   = mean_pf_2012 <= 0
...
forval year = 2012/2015 {
	...
	* ---------------------- PANEL A: OVERALL ---------------------- *
	// PANEL A: ALL
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo, vce(robust)
	...
	qui: sum n_emp_`year'       if e(sample) & mean_pf_2012 >0
	local mean_n_emp_`year'_1_a = r(mean)

	// PANEL A: SINGLE
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & pareja_2012 == 0, vce(robust)
	...
	// PANEL A: MARRIED
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & pareja_2012 == 1, vce(robust)
	...
	* ---------------------- PANEL B: HAS CHILDREN UNDER 18 ---------------------- *
	// PANEL B: ALL
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & n_hijos_less18_2012 > 0, vce(robust)
	...
	// PANEL B: SINGLE 
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & n_hijos_less18_2012 > 0 & pareja_2012 == 0, vce(robust)
	...
	// PANEL B: MARRIED
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & n_hijos_less18_2012 > 0 & pareja_2012 == 1, vce(robust)
	...
	* ---------------------- PANEL C: 12 YEARS OR LESS OF EDUCATION ---------------------- *
	// PANEL C: ALL
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & anios_educ_2012 <= 12, vce(robust)
	...
	// PANEL C: SINGLE 
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & anios_educ_2012 <= 12 & pareja_2012 == 0, vce(robust)
	...
	// PANEL C: MARRIED
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & anios_educ_2012 <= 12 & pareja_2012 == 1, vce(robust)
	...
	* ---------------------- PANEL D: 12 YEARS OR LESS OF EDUCATION AND HAS CHILDREN UNDER 18 ---------------------- *
	// PANEL D: ALL
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & anios_educ_2012 <= 12 & n_hijos_less18_2012 > 0, vce(robust)
	...
	// PANEL D: SINGLE 
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & anios_educ_2012 <= 12 & n_hijos_less18_2012 > 0 & pareja_2012 == 0, vce(robust)
	...
	// PANEL D: MARRIED
	qui:reg n_emp_`year' d_eleg_2012 mean_pf_2012 d_eleg_2012#c.mean_pf_2012 if mean_pf_2012 <= h_optimo & mean_pf_2012 >= -h_optimo & anios_educ_2012 <= 12 & n_hijos_less18_2012 > 0 & pareja_2012 == 1, vce(robust)
...
foreach x in a b c d {
	tw (scatter  beta_n_emp_1_`x' pos_1, msymbol(circle) msize(large) mcolor(blue*.8) mfcolor(blue*.8))      ///
	   ...
	   graph export "$salida/emp_mean_`title_`x''.pdf", as(pdf) replace
}
